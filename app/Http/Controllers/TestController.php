...
class TestController extends Controller
{
    ...
    public function apiTest(Request $request){
        ...
        // return $this->functions->getTtalReferralNumsByUser(11);
        // $this->functions->checkUsersWithNoMlmDbAndGiveThemOne();

        // return $this->functions->getNewEarnedSponsorForUser(64);

        // $ids_to_credit = $this->functions->getIdsToCreditPlacement(4, 24);
        ...
        // $this->functions->processQuarterlyRebirths();
        // $this->functions->processQuarterlyRebirths(11);
