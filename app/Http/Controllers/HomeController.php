...
class HomeController extends Controller
{
    ...
    public function tiktokReelsPage(Request $request){
        $props = [];
       ...
       $user = Auth::user();
        ...
        $props['create'] = $props_create;

        $posts = $this->functions->getReelsForExplorePage($user->id);
        // return $posts->count();
        if($posts->count() > 0){
        ...
        return Inertia::render('TiktokReels', $props);
    }
