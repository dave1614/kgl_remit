...
<template>
  <div v-if="openPostIndex !== false && openMediaIndex !== false"  class="fixed top-0 bottom-0 left-0 right-0 z-[900] ">
    ...
    <div class="absolute m-auto min-h-fit sm:max-h-[90%] md:max-h-[55%] lg:max-h-[90%]  top-0 bottom-0 left-0 right-0 bg-white dark:bg-slate-700 w-10/12  z-[1000] rounded ">
      ...
      <div class="relative h-full">
        ...
        <div class="w-full sm:h-full h-screen sm:grid sm:grid-cols-12 sm:gap-0 relative">
          ...
          <!-- <div v-else class="sm:col-span-6 sm:h-full h-[35%] col-span-12 bg-black">

          </div> -->

          <div class="sm:h-full  text-secondary-200 dark:text-slate-300 text-sm " :class="post.media.length == 0 ? 'sm:col-span-12 col-span-12 h-full' : 'sm:col-span-6 col-span-12 h-[65%]'">
            <div class="py-2 h-full">
              <div class="py-2 px-6 border-b-[1px] border-secondary-300 dark:border-slate-500" :class="post.media.length == 0 ? 'h-[7%] sm:h-fit' : 'h-[12%] sm:h-fit'">
              ...
              <div class="px-6 py-3  border-b-[1px] border-secondary-300 dark:border-slate-500 overflow-y-scroll" :class="post.media.length == 0 ? 'h-[70%] sm:h-[330px]' : 'h-[53%] sm:h-[330px]'">
              ...
              <div class="px-6  py-2 border-b-[1px] border-secondary-300 dark:border-slate-500" :class="post.media.length == 0 ? 'h-[14%] sm:h-fit' : 'h-[25%] sm:h-fit'">
              ...
              <div class="px-6 py-2 h-[10%] sm:h-full" :class="post.media.length == 0 ? 'h-[8%] sm:h-full' : 'h-[10%] sm:h-full'">
