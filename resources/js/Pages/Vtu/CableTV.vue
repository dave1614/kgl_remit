          ...
          <div class="grid grid-cols-12 gap-1">
            ...
            <div class="col-span-2 sm:col-span-1 card operator-card"
              ...
              <div class="card-body text-center">
                <img src="/special_images/dstv_logo.jpg" alt="DSTV" class="">
                <!-- <p>MTN</p> -->
              </div>
            ...
            <div class="col-span-2 sm:col-span-1 card operator-card"
              ...
              <div class="card-body text-center">
                <img src="/special_images/gotv_logo.jpg" alt="GOTV" class="">
                <!-- <p>MTN</p> -->
              </div>
            </div>
            ...
            <div class="col-span-2 sm:col-span-1 card operator-card"
              ...
              <div class="card-body text-center">
                <img src="/special_images/startimes_logo.jpg" alt="STARTIMES" class="col-12">
                <!-- <p>MTN</p> -->
              </div>
            </div>
