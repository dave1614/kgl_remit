              ...
              <tr v-for="(row,index) in history.data" :key="row.id">
                ...
                <td class="before:hidden lg:w-1 whitespace-nowrap">
                  <BaseButtons type="justify-start lg:justify-end" no-wrap>
                    ...
                    <BaseButton v-if="row.type == 'electricity' && row.order_id.slice(0, 2) == 'BP'" type="button" title="View your receipt"  :href="route('electricity_receipt', row.id)" color="bg-orange-500 text-white" target="_blank" label="Receipt"/>
