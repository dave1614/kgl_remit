    ...
    <LayoutAuthenticated>
        ...
        <SectionMain>
          ...
          label="Star on GitHub" color="contrast" rounded-full small /> -->
                ...
                <BaseButton
                    :href="route('user_vtu_history_page') + '?length=10&type=data&isDirty=true&__rememberable=true'"
        ...
        <b>Responsive table.</b> Collapses on mobile
            ...
            <CardBox isForm @submit.prevent="validateBuyDataRequest" class="">
                ...
                <div class="mx-2 my-9">
                    <div class="grid grid-cols-12 gap-1">
                        ...
                        <div class="col-span-2 sm:col-span-1 card network-card"
                            ...
                            <div class="card-body text-center">
                                <img src="/special_images/mtn_logo.png" alt="MTN" class="">
                                <!-- <p>MTN</p> -->
                            </div>
                        ...
                        <div class="col-span-2 sm:col-span-1 card network-card"
                            ...
                            <div class="card-body text-center">
                                <img src="/special_images/glo_logo.jpg" alt="GLO" class="">
                                <!-- <p>MTN</p> -->
                            </div>
                        </div>
                        ...
                        <div class="col-span-2 sm:col-span-1 card network-card"
                            :class="buy_data_request.network == 'airtel' ? 'selected' : ''"
                            @click="selectNetwork('airtel')">
                            <div class="card-body text-center">
                                <img src="/special_images/airtel_logo.png" alt="Airtel" class="">
                                <!-- <p>MTN</p> -->
                            </div>
                        </div>
                        ...
                        <div class="col-span-2 sm:col-span-1 card network-card"
                            :class="buy_data_request.network == '9mobile' ? 'selected' : ''"
                            @click="selectNetwork('9mobile')">
                            <div class="card-body text-center">
                                <img src="/special_images/9mobile_logo.png" alt="9mobile" class="">
                                <!-- <p>MTN</p> -->
                            </div>
                        </div>
                    ...
                    <div class="row">
                        <div v-if="buy_data_request.errors.network" class="form-error">{{
                            buy_data_request.errors.network }}
                        </div>
                    </div>
                </div>
                ...
                <div class="container" v-if="data_plans.length > 0">
                    <div @click="selectDataPlan(plan.index - 1)" class="data-plans-card card"
                    ...
                    <div class="">
                        <table class="table table-bordered ">
                            <tbody v-if="buy_data_request.selected_plan.length != {}">
                                <tr>
                                    <td>NETWORK</td>
                                    <td><em v-html="buy_data_request.selected_plan.network" class="text-primary"></em>
                                    </td>
                                </tr>
                                <tr>
                                    <td>DATA PLAN</td>
                                    <td><em v-html="buy_data_request.selected_plan.product_name"
                                            class="text-primary"></em></td>
                                </tr>
                                <tr>
                                    <td>AMOUNT</td>
                                    <td><em v-html="'₦ ' + mainStore.addCommas(buy_data_request.selected_plan.amount)"
                                            class="text-primary"></em></td>
                                </tr>
                                <tr>
                                    <td>PHONE</td>
...
const proceedWithMgrDataRequest = () => {
    ...
    buy_data_request.post(route('purchase_mgr_data'), {
        preserveScroll: true,
        onSuccess: (page) => {
            ...
            if (response.success) {
                ...
                var order_id = response.order_id;
                var amount_debited = response.amount;
                var transaction_pending = response.transaction_pending;
...
const confirmAndProceedWithTransaction = () => {
    ...
    } else if (sub_type == "mgr") {
        proceedWithMgrDataRequest();
