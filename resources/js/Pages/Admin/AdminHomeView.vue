<template>
    <LayoutAuthenticated>
        ...
        /> -->
          ...
          prefix="₦"
        /> -->
                <CardBoxWidget color=" text-yellow-500" :icon="mdiAccountMultiplePlus"
                    :number="parseInt(today_registered_users)" label="New Members" prefix="+" />
                <CardBoxWidget color="text-blue-500" :icon="mdiAccountGroup" :number="parseInt(total_registerd_users)"
                    prefix="" label="Total Members" />
                ...
                <CardBoxWidget color="text-red-500" :icon="mdiCreditCardPlus"
                    :number="parseFloat(total_amount_online_payment)" prefix="₦" label="Online Payment" />
...
const total_referrals = page.props.progressiveCommission;
