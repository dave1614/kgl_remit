...
const loadInvoices = async (url = null) => {
    ...
    const { response, error } = await useAxios(route('admin.invoices.all'), 'Loading invoices...', filters.value)
            ...
            <CardBox>
                ...
                <form @submit.prevent="loadInvoices" class="sm:grid sm:grid-cols-12 sm:gap-6">
                    ...
                    <div class="sm:col-span-3">
                        ...
                        <input v-model="filters.business_name" type="text" class="mt-1 block w-full rounded" />
                    </div>
                    <div class="sm:col-span-3">
                        <label class="block text-sm font-medium">User Name</label>
                        <input v-model="filters.user_name" type="text" class="mt-1 block w-full rounded" />
                    </div>
                    <div class="sm:col-span-3">
                        <label class="block text-sm font-medium">Email</label>
                        <input v-model="filters.email" type="text" class="mt-1 block w-full rounded" />
                    </div>
                    <div class="sm:col-span-3">
